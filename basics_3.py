...
Input The input contains two numbers in every line. 
...
Sample Testcase : INPUT 100 200 OUTPUT 100'''

kabali_ninjas,opp_ninjas=map(int,input().split())
print(opp_ninjas-kabali_ninjas)
